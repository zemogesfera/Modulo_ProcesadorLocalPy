...
'recibo','reciba','procedera','arriba','ciudadania','ingreso','morir','perder','situaciones',
'tio','citas','medicas','rpas','prescripcion','occidente','cesado','tengase','aportadas','plenario',
'nos','permitimos','memoriales','presentados','ordenes','reside','municipio','mejor',
'vieron','ahora','secuelas','positivo','negativo','recuperar','genera','estres',
'urolitiasis','destacado','ejercicio','evitar','evito','posibles','complicaciones',
